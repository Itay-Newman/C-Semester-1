...
void easyDifficulty(int numRounds);

// Function for the moderate difficulty level
void moderateDifficulty(int numRounds);

// Function for the hard difficulty level
void hardDifficulty(int numRounds);

// Function for the crazy difficulty level
void crazyDifficulty(int numRounds);
        ...
        while (1) {
            ...
            switch (choice) {
                case easy:
                    ...
                    break;
                case moderate:
                    moderateDifficulty(15);
                    break;
                case hard:
                    hardDifficulty(10);
                    break;
                case crazy:
                    crazyDifficulty(rand() % 21 + 5);
                    break;
            }
            break;
        }
